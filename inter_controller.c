// ======================================================
// inter_controller.c — Controlador intermediário (IC)
// ======================================================
// Este módulo simula o controlador de interrupções e dispositivos.
// Ele atua como intermediário entre o simulador do kernel e a camada
// de hardware simulada, gerando interrupções periódicas de timer (IRQ0)
// e notificando o kernel sobre a conclusão de operações de I/O simuladas (IRQ1).
#include "common.h"
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
